class RelationsController < ApplicationController
  ...
  private
    ...
    def relation_params
      params.require(:relation).permit(:company, :address, :postno, :city, :log, :category, :responsible, :phone, :next_action, :lock_version, :user_id, :type, :search_lock, :homepage, :email)
    end
end
