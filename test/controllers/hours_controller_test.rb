...
class HoursControllerTest < ActionController::TestCase
  ...
  test "should create hour" do
    assert_difference('Hour.count') do
      post :create, hour: { date: @hour.date, description: @hour.description, number: @hour.number, number: @hour.number, relation_id: @hour.relation_id, user_id: @hour.user_id }
    end
  ...
  test "should update hour" do
    patch :update, id: @hour, hour: { date: @hour.date, description: @hour.description, number: @hour.number, number: @hour.number, relation_id: @hour.relation_id, user_id: @hour.user_id }
    assert_redirected_to hour_path(assigns(:hour))
  end
