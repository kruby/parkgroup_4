...
class VouchersControllerTest < ActionController::TestCase
  ...
  test "should create voucher" do
    assert_difference('Voucher.count') do
      post :create, voucher: { date: @voucher.date, description: @voucher.description, hourly_rate: @voucher.hourly_rate, number: @voucher.number, relation_id: @voucher.relation_id, user_id: @voucher.user_id }
    end
  ...
  test "should update voucher" do
    patch :update, id: @voucher, voucher: { date: @voucher.date, description: @voucher.description, hourly_rate: @voucher.hourly_rate, number: @voucher.number, relation_id: @voucher.relation_id, user_id: @voucher.user_id }
    assert_redirected_to voucher_path(assigns(:voucher))
  end
